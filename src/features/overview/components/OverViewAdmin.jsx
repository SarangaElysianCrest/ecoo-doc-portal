...
export default function OverViewAdmin({ allData }) {
		...
		<>
			...
			<SectionRow>
				<DashDetailCard title='Company Registration' path='/web/companyRegistration'>
					...
					<CompRegRow
						title='Rejected'
						value={0 | allData?.companyRegistration?.rejectedCount}
						color='#d95757'
					/>
				</DashDetailCard>
				<DashDetailCard title='Certificate of Origin' path='/web/ecoo'>
					...
					<CompRegRow
						title='Rejected'
						value={allData?.companyRegistration?.rejectedCount}
						color='#d95757'
					/>
				</DashDetailCard>
			...
			<SectionRow>
				<DashDetailCard
					title='Accountant'
					headerIcon={<Avatar style={{ width: 24, height: 24 }} />}>
				...
				<DashDetailCard title='' headerIcon={<Avatar style={{ width: 24, height: 24 }} />}>
					<AccountantRow title='payment 1' value='6' color='#bb93d9' />
					<AccountantRow title='payment 2' value='6' color='#bb93d9' />
					<AccountantRow title='payment 3' value='6' color='#bb93d9' />
					<AccountantRow title='payment 4' value='6' color='#bb93d9' />
